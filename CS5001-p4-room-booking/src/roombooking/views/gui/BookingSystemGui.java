...
// public class BookingSystemGui implements ActionListener,
...
// public BookingSystemGui(BookingSystemModel model, BookingSystemController
// controller) {
// this.model = model;
...
// mainFrame.setSize(DEFAULT_FRAME_WIDTH, DEFAULT_FRAME_HEIGHT); // set frame
// size
...
// JOptionPane.showMessageDialog(mainFrame, msg, "Save Status",
...
// JOptionPane.showMessageDialog(mainFrame, "Starting fresh session", "Load
// Status",
// JOptionPane.INFORMATION_MESSAGE);
...
// JOptionPane.showMessageDialog(mainFrame, msg, "Load Status",
// JOptionPane.INFORMATION_MESSAGE);
// setupBookings();
// }
// }
...
// JLabel nameInfo = new JLabel("<html>Room Booking System for<br>%s
// Univeristy");
...
// listBox.getSelectedValuesList().toString());
// }
// });
